...
constexpr inline const char *cvar_error_name( const cvar_error_code_t error ) {
    switch ( error ) {
        case cvar_error_code_t::OK:                       return "OK";
        case cvar_error_code_t::ERR_NOT_INIT:             return "ERR_NOT_INIT";
        case cvar_error_code_t::ERR_IS_INIT:              return "ERR_IS_INIT";
        case cvar_error_code_t::ERR_INVALID_CVAR:         return "ERR_INVALID_CVAR";
...
constexpr inline const char *cvar_error_desc( const cvar_error_code_t error ) {
    switch ( error ) {
        case cvar_error_code_t::OK:                       return "success";
        case cvar_error_code_t::ERR_NOT_INIT:             return "cvar system is not initialized";
        case cvar_error_code_t::ERR_IS_INIT:              return "cvar system is already initialized";
        case cvar_error_code_t::ERR_INVALID_CVAR:         return "invalid cvar name or value was provided";
        ...
        default:                                          return "unknown cvar error";
    }
}
